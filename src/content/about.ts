export const about = {
  ...
  values: [
    ...
    {
      title: "Clarity",
      body: "Language you can spend against. If we cannot say it simply, we do not understand it yet. Ambiguity is allowed in a mood; it is not allowed in a plan.",
    },
    {
      title: "Creativity",
      body: "Not decoration. The shortest path to a feeling that numbers can later confirm. We would rather one image that holds than twelve that expire.",
    },
    {
      title: "Accountability",
      body: "Named owners. Named outcomes. No theatre of collaboration. The people in the pitch stay on the work, which is the only reputation that matters.",
    },
    {
      title: "Measurable impact",
      body: "Taste is not the opposite of measurement. We keep both on the table: contribution, qualified demand, memory, and the work’s right to exist in the archive.",
    },
  ],
  philosophy:
    "Creative meets performance in the edit. We do not run a brand studio and a growth studio as separate religions. A frame that cannot be cut for paid is unfinished. A media plan that cannot sit next to the lookbook is unfinished. The standard is one house, spoken in every room.",
  whyClients: [
  ...
  team: [
    {
      ...
      initials: "EM",
      bio: "Sets the world: image, type, and the line we will not cross. Previously led campaigns for fragrance and cultural houses.",
    },
    {
      name: "Rafael Okoye",
      role: "Head of Strategy",
      initials: "RO",
      bio: "Writes the brief the work can actually spend. Audience, offer, and the commercial spine of every season.",
    },
    {
      name: "Mina Cho",
      role: "Performance Lead",
      initials: "MC",
      bio: "Media, measurement, and the discipline of killing what is merely cheap. Paid with manners.",
    },
    {
      name: "Hugo Bell",
      role: "Design Director",
      initials: "HB",
      bio: "Identity systems, campaign worlds, and collateral that can survive a printer and a six-second cut.",
    },
    {
      name: "Priya Raman",
      role: "Film Lead",
      initials: "PR",
      bio: "Picture, sound, and the social lengths that still belong to the hero. If it cannot play in a dark room, it does not ship.",
    },
    {
      name: "Thomas Adler",
      role: "Growth Partner",
      initials: "TA",
      bio: "The commercial relationship. Scope, seasons, and the conversation with the client’s board when the work must be explained.",
    },
  ],
  note: "Portraits and biographies are placeholders for the founding roster and will be replaced with live profiles before public launch.",
} as const;
